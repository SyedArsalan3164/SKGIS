...
public class PaysimRecord {
    ...
    public PaysimRecord(String txnId, long step, String type, double amount, String nameOrig, 
                        double oldbalanceOrg, double newbalanceOrig, String nameDest, 
                        double oldbalanceDest, double newbalanceDest, int isFraud, 
                        String deviceId, String bankAccountId) {
        this.txnId = txnId;
        this.step = step;
        this.type = type;
        this.amount = amount;
